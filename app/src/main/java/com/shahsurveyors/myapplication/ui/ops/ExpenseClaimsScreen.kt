...
fun ExpenseClaimsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    ScrollableTabRow(
                        ...
                        categories.forEach { cat ->
                            Tab(
                                ...
                                text = { Text(text = cat, fontSize = 10.sp) }
                            )
                        }
                    }
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(containerColor = ShahLightGrey, contentColor = ShahBlack)
                    ) {
                    ...
                    if (capturedBitmap != null) {
                        ...
                        Text(text = "Receipt captured successfully ✓", color = SuccessGreen, fontSize = 11.sp)
                    }
            ...
            Text(
                text = "Receipt and expense details will be securely stored in Firebase. The claim will remain pending until Admin approval.",
                color = ShahMediumGrey,
                fontSize = 11.sp
            )
        }
