...
interface AppDao {
    ...
    @Query("UPDATE billing_documents SET paymentStatus = :paymentStatus, paidAmount = :paidAmount WHERE id = :documentId")
    suspend fun updatePaymentStatus(documentId: Long, paymentStatus: String, paidAmount: Double)
