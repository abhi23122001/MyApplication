                ...
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
                    ...
                    MainScaffold(
                        ...
                        NavHost(navController = navController, startDestination = "splash", modifier = modifier) {
                            ...
                            composable("projects") { androidx.compose.foundation.layout.Box(modifier = Modifier.fillMaxSize(), contentAlignment = androidx.compose.ui.Alignment.Center) { androidx.compose.material3.Text(text = "Projects module") } }
                            composable("marketing") { androidx.compose.foundation.layout.Box(modifier = Modifier.fillMaxSize()) }
                        }
                    }
                }
            }
